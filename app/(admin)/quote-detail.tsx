...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  backChip: { paddingHorizontal: 22, paddingVertical: 11, borderRadius: 12, borderWidth: 1.5, borderColor: theme.primary },
  headerCenter: { flex: 1 },
  ...
  sectionTitle: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.textTertiary, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 4 },
  valueMain: { fontSize: 17, fontFamily: "Inter_700Bold", color: theme.text },
  valueSub: { fontSize: 14, fontFamily: "Inter_400Regular", color: theme.textSecondary, flex: 1 },
  infoRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  label: { fontSize: 13, fontFamily: "Inter_500Medium", color: theme.textTertiary, width: 110 },
  value: { fontSize: 14, fontFamily: "Inter_500Medium", color: theme.text, flex: 1 },
  prose: { fontSize: 14, fontFamily: "Inter_400Regular", color: theme.text, lineHeight: 22 },
  lineItem: { paddingVertical: 10, gap: 6 },
  lineDesc: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: theme.text },
  lineRow: { flexDirection: "row", alignItems: "center", gap: 8, flexWrap: "wrap" },
  lineDetail: { fontSize: 13, fontFamily: "Inter_400Regular", color: theme.textSecondary },
  lineTotal: { fontSize: 14, fontFamily: "Inter_700Bold", color: theme.text, marginLeft: "auto" },
  totalRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 2 },
  totalRowMain: { paddingTop: 10, borderTopWidth: 1, borderTopColor: theme.border, marginTop: 4 },
  ...
  photo: { width: 120, height: 90, borderRadius: 12, marginRight: 10 },
  statusActions: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  statusBtn: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, borderWidth: 1.5 },
  ...
  actionBtnSecondary: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    borderRadius: 14, paddingVertical: 13, borderWidth: 1.5, borderColor: theme.primary + "40",
  },
  actionBtnSecondaryText: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.primary },
});
