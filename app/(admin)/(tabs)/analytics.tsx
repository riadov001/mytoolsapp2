...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  headerTitle: { fontSize: 22, fontFamily: "Inter_700Bold", color: theme.text, flex: 1 },
  premiumBadge: { backgroundColor: theme.primary + "15", paddingHorizontal: 12, paddingVertical: 5, borderRadius: 10 },
  premiumBadgeText: { fontSize: 11, fontFamily: "Inter_700Bold", color: theme.primary, textTransform: "uppercase" },

  sectionLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: theme.textTertiary, textTransform: "uppercase", letterSpacing: 0.6 },
  sectionTitle: { fontSize: 17, fontFamily: "Inter_700Bold", color: theme.text },
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 14 },

  kpiGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  kpiCard: {
    flex: 1, minWidth: 160, backgroundColor: theme.surface, borderRadius: 16, borderWidth: 1,
    borderColor: theme.border, padding: 16, alignItems: "center", gap: 8,
    shadowColor: theme.shadow, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2,
  },
  kpiValue: { fontSize: 20, fontFamily: "Inter_700Bold", color: theme.text },
  kpiLabel: { fontSize: 12, fontFamily: "Inter_500Medium", color: theme.textTertiary, textAlign: "center" },
  ...
  chartBar: { width: "100%", backgroundColor: theme.primary, borderRadius: 6 },
  chartBarLabel: { fontSize: 10, fontFamily: "Inter_500Medium", color: theme.textTertiary },
  ...
  predictionCard: { backgroundColor: theme.background, borderRadius: 12, padding: 16, alignItems: "center", gap: 10 },
  predictionValue: { fontSize: 26, fontFamily: "Inter_700Bold", color: theme.primary },
  predictionLabel: { fontSize: 13, fontFamily: "Inter_500Medium", color: theme.textSecondary, textAlign: "center" },
  trendBadge: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: theme.primary + "10", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  trendText: { fontSize: 12, fontFamily: "Inter_700Bold" },

  insightCard: { backgroundColor: theme.background, borderRadius: 12, padding: 14, gap: 6, borderLeftWidth: 3, borderLeftColor: theme.primary },
  insightTitle: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.text },
  insightDesc: { fontSize: 13, fontFamily: "Inter_400Regular", color: theme.textSecondary, lineHeight: 18 },
  insightRec: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.primary, marginTop: 4 },

  recCard: { flexDirection: "row", gap: 12, alignItems: "flex-start", backgroundColor: theme.background, borderRadius: 12, padding: 14 },
  recIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: theme.primary + "10", justifyContent: "center", alignItems: "center", marginTop: 2 },
  recTitle: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.text },
  recDesc: { fontSize: 12, fontFamily: "Inter_400Regular", color: theme.textSecondary, marginTop: 2, lineHeight: 16 },

  upgradeCard: {
    backgroundColor: theme.primary + "06", borderRadius: 16, borderWidth: 1.5,
    borderColor: theme.primary + "30", padding: 28, alignItems: "center", gap: 14,
  },
  upgradeTitle: { fontSize: 18, fontFamily: "Inter_700Bold", color: theme.text },
  upgradeDesc: { fontSize: 14, fontFamily: "Inter_400Regular", color: theme.textSecondary, textAlign: "center", lineHeight: 20 },
  upgradeBtn: {
  ...
  summaryStat: {
    flex: 1, minWidth: 130, backgroundColor: theme.surface, borderRadius: 14, borderWidth: 1,
    borderColor: theme.border, padding: 14, alignItems: "center", gap: 6,
    shadowColor: theme.shadow, shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 1,
  },
  summaryValue: { fontSize: 17, fontFamily: "Inter_700Bold", color: theme.text },
  summaryLabel: { fontSize: 11, fontFamily: "Inter_500Medium", color: theme.textTertiary, textAlign: "center" },
});
