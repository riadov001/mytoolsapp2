...
function getStyles(theme: ThemeColors) {
  return StyleSheet.create({
    ...
    submitHeaderText: { color: "#fff", fontSize: 14, fontFamily: "Inter_700Bold" },
    section: { gap: 12 },
    sectionTitle: { fontSize: 15, fontFamily: "Inter_700Bold", color: theme.text },
    pickerBtn: {
      flexDirection: "row",
      alignItems: "center",
      justifyContent: "space-between",
    ...
    noClient: { paddingHorizontal: 14, paddingVertical: 14, color: theme.textTertiary },
    addClientBtn: {
    ...
    serviceName: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.text, flex: 1 },
    serviceDesc: { fontSize: 12, fontFamily: "Inter_400Regular", color: theme.textTertiary, marginTop: 2 },
    servicePrice: { fontSize: 13, fontFamily: "Inter_700Bold", color: theme.primary },
    photoItem: {
      flexDirection: "row",
      alignItems: "center",
      gap: 12,
    ...
    lineItemLabel: { fontSize: 14, fontFamily: "Inter_700Bold", color: theme.text },
    lineItemRow: {
      flexDirection: "row",
      gap: 10,
    },
    fieldLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.textTertiary, marginBottom: 5 },
    tvaSelector: {
      flexDirection: "row",
      gap: 5,
    },
    ...
    tvaBtnText: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.text },
    lineTotalCalc: { fontSize: 13, fontFamily: "Inter_700Bold", color: theme.primary, marginTop: 4 },
    addLineBtn: {
      flexDirection: "row",
      alignItems: "center",
      justifyContent: "center",
