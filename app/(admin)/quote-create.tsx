          ...
          {showClientPicker && (
            <View style={styles.clientDropdown}>
              ...
              <Pressable
                ...
                onPress={() => router.push({ pathname: "/(admin)/client-form", params: { returnTo: "quote-create" } })}
              >
...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 18, fontFamily: "Inter_700Bold", color: theme.text },
  submitBtn: {
    paddingHorizontal: 18, paddingVertical: 10, borderRadius: 12,
    backgroundColor: theme.primary, justifyContent: "center", alignItems: "center", minWidth: 64,
  ...
  section: {
    ...
    padding: 16, gap: 12,
    shadowColor: theme.shadow, shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2,
  },
  sectionTitle: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.textTertiary, textTransform: "uppercase", letterSpacing: 0.8 },
  pickerBtn: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "center",
    borderWidth: 1.5, borderColor: theme.inputBorder || theme.border, borderRadius: 12,
    paddingHorizontal: 14, paddingVertical: 13, backgroundColor: theme.inputBg || theme.background,
  },
  pickerText: { fontSize: 15, fontFamily: "Inter_400Regular", color: theme.text, flex: 1 },
  clientDropdown: {
    borderWidth: 1, borderColor: theme.border, borderRadius: 12,
    backgroundColor: theme.background, overflow: "hidden", marginTop: 6,
  },
  clientSearch: {
  ...
  clientOption: { paddingHorizontal: 14, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: theme.border },
  clientOptionName: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.text },
  clientOptionEmail: { fontSize: 12, fontFamily: "Inter_400Regular", color: theme.textTertiary, marginTop: 2 },
  noClient: { padding: 14, fontSize: 13, fontFamily: "Inter_400Regular", color: theme.textTertiary, textAlign: "center" },
  addClientBtn: {
    flexDirection: "row", alignItems: "center", gap: 10,
  ...
  textarea: {
    minHeight: 80, borderWidth: 1.5, borderColor: theme.inputBorder || theme.border, borderRadius: 12,
  ...
  lineItemCard: {
    backgroundColor: theme.background, borderRadius: 14, borderWidth: 1, borderColor: theme.border,
    padding: 14, gap: 10,
  ...
  fieldLabel: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: theme.textTertiary, marginBottom: 5 },
  tvaSelector: { flexDirection: "row", gap: 5 },
  tvaBtn: {
    flex: 1, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: theme.border,
    justifyContent: "center", alignItems: "center", backgroundColor: theme.surface,
  },
  tvaBtnText: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.textSecondary },
  lineTotalCalc: { fontSize: 13, fontFamily: "Inter_700Bold", color: theme.primary, textAlign: "right" },
  addLineBtn: { flexDirection: "row", alignItems: "center", gap: 8, justifyContent: "center", paddingVertical: 12 },
  addLineBtnText: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.primary },
  serviceOption: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, paddingHorizontal: 12, borderBottomWidth: 1, borderBottomColor: theme.border },
  serviceName: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.text },
  serviceDesc: { fontSize: 12, fontFamily: "Inter_400Regular", color: theme.textSecondary, marginTop: 2 },
  servicePrice: { fontSize: 13, fontFamily: "Inter_700Bold", color: theme.textSecondary, marginLeft: 8 },
  lockedText: {
    fontSize: 15, fontFamily: "Inter_500Medium", color: theme.text,
  ...
  photoItem: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 10, marginVertical: 4, backgroundColor: theme.background, borderRadius: 10, paddingHorizontal: 10 },
  photoThumb: { width: 52, height: 52, borderRadius: 8 },
  photoName: { fontSize: 12, fontFamily: "Inter_400Regular", color: theme.textSecondary },
  addPhotoBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 12, borderWidth: 1.5, borderColor: theme.border, borderRadius: 12, marginTop: 8 },
  ...
  totalValue: { fontSize: 15, fontFamily: "Inter_700Bold", color: theme.text },
  createBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 10, backgroundColor: theme.primary, borderRadius: 16,
  ...
  ocrBannerTitle: { fontSize: 14, fontFamily: "Inter_700Bold" },
