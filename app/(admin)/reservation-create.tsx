...
const getStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 18, fontFamily: "Inter_700Bold", color: theme.text, textAlign: "center" },
  section: {
  ...
  pickerBtn: {
    ...
    backgroundColor: theme.inputBg || theme.background, borderRadius: 12, borderWidth: 1.5,
    borderColor: theme.inputBorder || theme.border, paddingHorizontal: 14, paddingVertical: 13,
  },
  pickerText: { fontSize: 15, fontFamily: "Inter_400Regular", color: theme.text },
  clientDropdown: { borderRadius: 12, borderWidth: 1, borderColor: theme.border, overflow: "hidden", marginTop: 6 },
  clientSearch: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: theme.border, backgroundColor: theme.background },
  ...
  clientOption: { paddingHorizontal: 14, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: theme.border, gap: 2 },
  ...
  clientAvatar: { width: 40, height: 40, borderRadius: 12, backgroundColor: theme.primary + "15", justifyContent: "center", alignItems: "center" },
  ...
  quoteSelected: {
    ...
    backgroundColor: theme.primary + "10", borderRadius: 12, borderWidth: 1,
    borderColor: theme.primary + "40", paddingHorizontal: 14, paddingVertical: 12,
  },
  quoteSelectedIcon: { width: 38, height: 38, borderRadius: 10, backgroundColor: theme.primary + "15", justifyContent: "center", alignItems: "center" },
  quoteSelectedRef: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: theme.primary },
  field: { gap: 6 },
  fieldLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: theme.textSecondary },
  input: {
    backgroundColor: theme.inputBg || theme.background, borderRadius: 12, borderWidth: 1.5,
    borderColor: theme.inputBorder || theme.border, paddingHorizontal: 14, paddingVertical: 12,
  ...
  submitBtnDisabled: { backgroundColor: theme.border, shadowOpacity: 0 },
